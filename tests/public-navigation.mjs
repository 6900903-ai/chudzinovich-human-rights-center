...
for(const href of ['/search/','/videos/','/faq/','/regions/','/case-index/','/sources/','/media/','/channels/','/press/','/methodology/','/corrections/','/contacts/','/privacy/','/security/','/terms/'])assert.ok(ru.includes(`href="${href}"`),`RU shell missing ${href}`);
