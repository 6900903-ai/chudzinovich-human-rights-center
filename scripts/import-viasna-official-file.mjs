...
const structuralFindings=anomalies.filter(item=>item.severity==='HIGH'||item.severity==='BLOCK');
...
if(expectedPrisons!==null&&prepared.prisons!==expectedPrisons)throw new Error(`VIASNA_CANDIDATE_PRISON_COUNT_MISMATCH:${prepared.prisons}:${expectedPrisons}`);
