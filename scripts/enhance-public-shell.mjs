...
const MARKER='<!-- CHUDO_PUBLIC_NAV_V10 -->';
const COPY={
 ru:{search:'Поиск',videos:'Видео',faq:'Частые вопросы',regions:'Регионы и годы',caseIndex:'Суды и статьи УК',sources:'Источники',media:'СМИ',channels:'Telegram-источники',press:'Для СМИ',methodology:'Методология',corrections:'Исправления',contacts:'Контакты',privacy:'Конфиденциальность',security:'Безопасность',terms:'Условия использования',archive:'Публичный правозащитный архив',menu:'Открыть меню',previous:'Прокрутить меню назад',next:'Прокрутить меню вперёд',siteMenu:'Меню сайта',closeMenu:'Закрыть меню',languages:'Языки',homeTitle:'Правозащитный центр CHUDO — политзаключённые и репрессии в Беларуси',homeDescription:'Правозащитный центр CHUDO документирует политические репрессии в Беларуси, сохраняет сведения об источниках, политзаключённых, местах заключения, новостях и правозащитном мониторинге.'},
 be:{search:'Пошук',videos:'Відэа',faq:'Частыя пытанні',regions:'Рэгіёны і гады',caseIndex:'Суды і артыкулы КК',sources:'Крыніцы',media:'СМІ',channels:'Telegram-крыніцы',press:'Для СМІ',methodology:'Метадалогія',corrections:'Выпраўленні',contacts:'Кантакты',privacy:'Прыватнасць',security:'Бяспека',terms:'Умовы выкарыстання',archive:'Публічны праваабарончы архіў',menu:'Адкрыць меню',previous:'Пракруціць меню назад',next:'Пракруціць меню наперад',siteMenu:'Меню сайта',closeMenu:'Закрыць меню',languages:'Мовы',homeTitle:'Праваабарончы цэнтр CHUDO — палітвязні і рэпрэсіі ў Беларусі',homeDescription:'Праваабарончы цэнтр CHUDO дакументуе палітычныя рэпрэсіі ў Беларусі, захоўвае звесткі пра крыніцы, палітвязняў, месцы зняволення, навіны і праваабарончы маніторынг.'},
 en:{search:'Search',videos:'Videos',faq:'FAQ',regions:'Regions and years',caseIndex:'Courts and articles',sources:'Sources',media:'Media',channels:'Telegram sources',press:'For media',methodology:'Methodology',corrections:'Corrections',contacts:'Contacts',privacy:'Privacy',security:'Security',terms:'Terms of use',archive:'Public human-rights archive',menu:'Open menu',previous:'Scroll navigation back',next:'Scroll navigation forward',siteMenu:'Site menu',closeMenu:'Close menu',languages:'Languages',homeTitle:'CHUDO Human Rights Center — Political Prisoners and Repression in Belarus',homeDescription:'CHUDO Human Rights Center documents political repression in Belarus and preserves source-attributed information about political prisoners, detention facilities, news and human-rights monitoring.'},
 pl:{search:'Szukaj',videos:'Wideo',faq:'FAQ',regions:'Regiony i lata',caseIndex:'Sądy i artykuły',sources:'Źródła',media:'Media',channels:'Źródła Telegram',press:'Dla mediów',methodology:'Metodologia',corrections:'Korekty',contacts:'Kontakt',privacy:'Prywatność',security:'Bezpieczeństwo',terms:'Warunki korzystania',archive:'Publiczne archiwum praw człowieka',menu:'Otwórz menu',previous:'Przewiń menu wstecz',next:'Przewiń menu dalej',siteMenu:'Menu strony',closeMenu:'Zamknij menu',languages:'Języki',homeTitle:'CHUDO — więźniowie polityczni i represje na Białorusi',homeDescription:'Centrum Praw Człowieka CHUDO dokumentuje represje polityczne na Białorusi i zachowuje informacje ze wskazaniem źródeł o więźniach politycznych, miejscach osadzenia, wiadomościach i monitoringu praw człowieka.'}
};
...
function utilityLinks(lang,cls=''){const c=COPY[lang];const items=[['/search/',c.search],['/videos/',c.videos],['/faq/',c.faq],['/regions/',c.regions],['/case-index/',c.caseIndex],['/sources/',c.sources],['/media/',c.media],['/channels/',c.channels],['/press/',c.press],['/methodology/',c.methodology],['/corrections/',c.corrections],['/contacts/',c.contacts],['/privacy/',c.privacy],['/security/',c.security],['/terms/',c.terms]];return `<nav class="${cls}" aria-label="${attr(c.archive)}">${items.map(([path,label])=>`<a href="${href(lang,path)}">${label}</a>`).join('')}</nav>`;}
...
console.log(`PUBLIC_SHELL_ENHANCE=PASS files=${changed} localized_a11y=PASS homepage_metadata=PASS`);
