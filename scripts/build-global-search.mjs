...
const COPY={
 ru:{title:'Поиск',intro:'Поиск по публичной базе CHUDO, местам заключения, видео, новостям, судебным индексам и зарегистрированным источникам. Запрос обрабатывается только в вашем браузере.',placeholder:'Имя, статья УК, судья, видео, место, новость или источник…',all:'Все',person:'Люди',prison:'Места заключения',case:'Суды / статьи',video:'Видео',news:'Новости',media:'СМИ',telegram:'Telegram',empty:'Ничего не найдено.',hint:'Введите минимум 2 символа.',found:'Найдено',article:'Статья УК',judge:'Судья',prosecutor:'Прокурор'},
 be:{title:'Пошук',intro:'Пошук па публічнай базе CHUDO, месцах зняволення, відэа, навінах, судовых індэксах і зарэгістраваных крыніцах. Запыт апрацоўваецца толькі ў вашым браўзеры.',placeholder:'Імя, артыкул КК, суддзя, відэа, месца, навіна або крыніца…',all:'Усе',person:'Людзі',prison:'Месцы зняволення',case:'Суды / артыкулы',video:'Відэа',news:'Навіны',media:'СМІ',telegram:'Telegram',empty:'Нічога не знойдзена.',hint:'Увядзіце мінімум 2 сімвалы.',found:'Знойдзена',article:'Артыкул КК',judge:'Суддзя',prosecutor:'Пракурор'},
 en:{title:'Search',intro:'Search the public CHUDO database, detention facilities, videos, news, court indexes and registered sources. Your query is processed only in your browser.',placeholder:'Name, Criminal Code article, judge, video, place, news or source…',all:'All',person:'People',prison:'Detention places',case:'Courts / articles',video:'Videos',news:'News',media:'Media',telegram:'Telegram',empty:'Nothing found.',hint:'Enter at least 2 characters.',found:'Found',article:'Criminal Code article',judge:'Judge',prosecutor:'Prosecutor'},
 pl:{title:'Wyszukiwanie',intro:'Przeszukuj publiczną bazę CHUDO, miejsca osadzenia, wideo, aktualności, indeksy sądowe i zarejestrowane źródła. Zapytanie jest przetwarzane wyłącznie w przeglądarce.',placeholder:'Osoba, artykuł kodeksu, sędzia, wideo, miejsce, wiadomość lub źródło…',all:'Wszystko',person:'Osoby',prison:'Miejsca osadzenia',case:'Sądy / artykuły',video:'Wideo',news:'Aktualności',media:'Media',telegram:'Telegram',empty:'Brak wyników.',hint:'Wpisz co najmniej 2 znaki.',found:'Znaleziono',article:'Artykuł kodeksu',judge:'Sędzia',prosecutor:'Prokurator'}
};
...
console.log(`GLOBAL_SEARCH_BUILD=PASS people=${people.length} prisons=${prisons.length} case_records=${caseRecords('ru').length} videos=${videos.length} news=${news.length} media=${media.length} telegram=${channels.length} test_mode=${testMode}`);
