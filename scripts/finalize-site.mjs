...
let notFound=layout({lang:'ru',title:'Страница не найдена',description:'Страница не найдена — CHUDO Human Rights Center',path:'/404.html',body:notFoundBody,noIndex:true});
...
console.log(`SITE_FINALIZE=PASS sitemap_urls=${urls.length} search_noindex=4 robots=PASS 404=PASS`);
